...
export const EXPERIENCE = [
  ...
  },
  {
    ...
    description:
      "Support to ensure the correct operation of the company’s production processes. As well as meeting the business needs to facilitate the performance of their task, either by making improvements to the application, by obtaining reports or manipulating and fixing data.",
    tags: [TECHNOLOGIES.ORACLE],
  },
  {
    date_start: "nov 2012",
